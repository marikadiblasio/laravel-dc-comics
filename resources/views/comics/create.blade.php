    ...
    <div class="my-form-height container">
        <form action="{{ route('comics.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('thumb') is-invalid @enderror" id="thumb" name="thumb" rows="5">{{old('thumb')}}</textarea>
            </div>
            @error('thumb')
            <div class="alert alert-danger">
                {{$message}}
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="9">{{old('description')}}</textarea>
            </div>
            @error('description')
            <div class="alert alert-danger">
                {{$message}}
            ...
            <div class="row mb-3">
                ...
                <div class="col">
                    ...
                    value="{{old('series')}}" placeholder="Inserisci qui la serie">
                </div>
                @error('series')
                <div class="alert alert-danger">
                    {{$message}}
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    value="{{old('date')}}" placeholder="Inserisci qui la data di uscita">
                </div>
                @error('sale_date')
                <div class="alert alert-danger">
                    {{$message}}
                ...
                <div class="col">
                    ...
                    value="{{old('type')}}" placeholder="Inserisci qui il genere">
                </div>
                @error('type')
                <div class="alert alert-danger">
                    {{$message}}
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('artists') is-invalid @enderror" id="artists" name="artists" rows="5">{{old('thumb')}}</textarea>
            </div>
            @error('artists')
            <div class="alert alert-danger">
                {{$message}}
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('artists') is-invalid @enderror" id="writers" name="writers" rows="5">{{old('thumb')}}</textarea>
            </div>
            @error('writers')
            <div class="alert alert-danger">
                {{$message}}
